        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "郑远洋被谋杀于样本储藏室",
            entityIds: ["zheng_yuanyang", "sample_storage"],
            stance: "accepted",
            basis: "first_hand",
          ...
          },
          {
            ...
            holderId: "xu_ran",
            claim: "玩家角色可能杀害了郑远洋",
            entityIds: ["player_char", "zheng_yuanyang"],
            stance: "hypothetical",
            basis: "inference",
            sourceEpisodeId: "a1_ep",
          },
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "玩家角色声称昨夜待在宿舍",
            entityIds: ["player_char", "dormitory"],
            stance: "hypothetical",
            basis: "hearsay",
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "三把储藏室钥匙分别在郑远洋、徐然和玩家手中",
            entityIds: ["storage_key", "sample_storage"],
            stance: "accepted",
            basis: "first_hand",
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "被困在研究站是有人蓄意为之",
            entityIds: ["research_station", "xu_ran"],
            stance: "accepted",
            basis: "inference",
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "U盘从郑远洋办公室的保险柜中被取走",
            entityIds: ["usb_drive_missing", "office"],
            stance: "accepted",
            basis: "first_hand",
          ...
          },
          {
            ...
            holderId: "xu_ran",
            claim: "玩家角色声称郑远洋曾告知其关于U盘的事",
            entityIds: ["player_char", "usb_drive_missing"],
            stance: "hypothetical",
            basis: "hearsay",
            sourceEpisodeId: "b1_ep",
          },
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "数字纸条可能是实验室电脑的密码",
            entityIds: ["paper_note", "laboratory"],
            stance: "tentative",
            basis: "inference",
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "无线电室被具备专业知识的人蓄意破坏",
            entityIds: ["radio_room", "research_station"],
            stance: "accepted",
            basis: "first_hand",
          ...
          },
          {
            ...
            holderId: "xu_ran",
            claim: "研究站可能存在与郑远洋谋杀案相关的未知第三人",
            entityIds: ["research_station", "zheng_yuanyang"],
            stance: "hypothetical",
            basis: "inference",
            sourceEpisodeId: "b4_ep",
          },
      ...
      memoryEffects: {
        ...
        assertions: [
          ...
          },
          {
            ...
            holderId: "xu_ran",
            claim: "郑远洋的实验室电脑上有一个在命案当夜被修改过的「保险」文件夹",
            entityIds: ["zheng_yuanyang", "laboratory"],
            stance: "tentative",
            basis: "first_hand",
            sourceEpisodeId: "b5_ep",
          },
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "徐然气象员的伪装身份遭到有力质疑",
            entityIds: ["xu_ran", "meteorological_platform"],
            stance: "tentative",
            basis: "first_hand",
          ...
          },
          {
            ...
            holderId: "xu_ran",
            claim: "「深蓝哨兵」组织的名字将徐然与郑远洋关联起来",
            entityIds: ["xu_ran", "zheng_yuanyang"],
            stance: "tentative",
            basis: "inference",
            sourceEpisodeId: "c1_ep",
          },
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "玩家角色的实际身份是记者而非海洋生物学家",
            entityIds: ["player_char"],
            stance: "accepted",
            basis: "first_hand",
      ...
      memoryEffects: {
        ...
        assertions: [
          ...
          },
          {
            ...
            holderId: "xu_ran",
            claim: "徐然与玩家角色在进行平行调查",
            entityIds: ["xu_ran", "player_char"],
            stance: "tentative",
            basis: "inference",
            sourceEpisodeId: "c3_ep",
          },
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "郑远洋通过研究站转运远潮生物科技的非法样本",
            entityIds: ["zheng_yuanyang", "research_station"],
            stance: "accepted",
            basis: "first_hand",
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "根据伪造转账记录，徐然似乎收到了远潮的付款",
            entityIds: ["xu_ran", "transfer_record"],
            stance: "contested",
            basis: "first_hand",
      ...
      memoryEffects: {
        ...
        assertions: [
          ...
          },
          {
            cognitionKey: "third_person_hypothesis",
            holderId: "xu_ran",
            claim: "未知第三人在命案当夜使用了实验室电脑",
            entityIds: ["research_station", "laboratory"],
            stance: "tentative",
            basis: "inference",
            sourceEpisodeId: "d2_ep",
          },
        ...
        assertions: [
          {
            cognitionKey: "third_person_hypothesis",
            holderId: "xu_ran",
            claim: "已确认有不明入侵者出现在样本储藏室",
            entityIds: ["research_station", "sample_storage"],
            stance: "accepted",
            basis: "first_hand",
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "玩家角色关于如何得知U盘一事给出了前后矛盾的说法",
            entityIds: ["player_char", "usb_drive_missing"],
            stance: "accepted",
            basis: "first_hand",
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "泥脚印证明有第三人出现在样本储藏室",
            entityIds: ["mud_footprint", "sample_storage"],
            stance: "confirmed",
            basis: "first_hand",
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "郑远洋在北区设备舱秘密会见远潮联络人",
            entityIds: ["zheng_yuanyang", "north_equipment_shed"],
            stance: "accepted",
            basis: "first_hand",
          ...
          },
          {
            ...
            holderId: "xu_ran",
            claim: "隐藏的U盘包含远潮对郑远洋进行胁迫的录音",
            entityIds: ["usb_drive_hidden", "zheng_yuanyang"],
            stance: "accepted",
            basis: "first_hand",
            sourceEpisodeId: "f2_ep",
          },
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "玩家角色持有与北区设备舱坐标吻合的地图",
            entityIds: ["player_char", "north_equipment_shed"],
            stance: "accepted",
            basis: "first_hand",
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "北区设备舱是与泥脚印匹配的第三人藏身据点",
            entityIds: ["north_equipment_shed", "mud_footprint"],
            stance: "confirmed",
            basis: "first_hand",
          ...
          },
          {
            cognitionKey: "north_shed_liaison",
            holderId: "xu_ran",
            claim: "北区设备舱曾被远潮联络人用作与郑远洋会面的据点",
            entityIds: ["north_equipment_shed", "zheng_yuanyang"],
            stance: "confirmed",
            basis: "first_hand",
            sourceEpisodeId: "f4_ep",
          },
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "陈卫国是研究站前站长兼远潮生物科技的清道夫",
            entityIds: ["chen_weiguo", "research_station"],
            stance: "confirmed",
            basis: "first_hand",
          ...
          },
          {
            ...
            holderId: "xu_ran",
            claim: "陈卫国是储藏室泥脚印的主人",
            entityIds: ["chen_weiguo", "mud_footprint"],
            stance: "confirmed",
            basis: "first_hand",
            sourceEpisodeId: "g1_ep",
          },
        ...
        assertions: [
          {
            ...
            holderId: "xu_ran",
            claim: "陈卫国杀害了郑远洋",
            entityIds: ["chen_weiguo", "zheng_yuanyang"],
            stance: "confirmed",
            basis: "first_hand",
          ...
          },
          {
            ...
            holderId: "xu_ran",
            claim: "陈卫国从保险柜中盗走了U盘",
            entityIds: ["chen_weiguo", "usb_drive_missing"],
            stance: "confirmed",
            basis: "first_hand",
            sourceEpisodeId: "g2_ep",
          },
          {
            ...
            holderId: "xu_ran",
            claim: "陈卫国伪造了转账记录以嫁祸徐然",
            entityIds: ["chen_weiguo", "transfer_record"],
            stance: "confirmed",
            basis: "first_hand",
            sourceEpisodeId: "g2_ep",
          },
